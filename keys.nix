{
  hosts = {
    ...
    numenor = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJSXrXXDzr859vF0tbLKLdtmjVn/4PSqtWcBRLqBmK8q root@numenor";
  };
  ...
  users = {
    stranger = {
      ...
      numenor = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPdIgHvJmJE1X6fVR0M5nFRRdMo8PE1q7xQzwSpUEMBK stranger-key-numenor";
    };
  };
}
